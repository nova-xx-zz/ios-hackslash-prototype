...
const ENEMY_TEMPLATES = [
  { key: "slime", name: "スライム", hp: 16, atk: 6, mag: 0, def: 2, spd: 4, exp: 6, jp: 4, color: "#4dc37a", tamable: true, tameChance: 0.35 },
  { key: "goblin", name: "ゴブリン", hp: 24, atk: 9, mag: 0, def: 4, spd: 6, exp: 9, jp: 6, color: "#8fae4d", tamable: true, tameChance: 0.22 },
  { key: "bat", name: "コウモリ", hp: 12, atk: 7, mag: 0, def: 1, spd: 10, exp: 7, jp: 5, color: "#8a6dd1", tamable: true, tameChance: 0.28 },
  { key: "wolf", name: "ウルフ", hp: 22, atk: 10, mag: 0, def: 3, spd: 8, exp: 10, jp: 6, color: "#c9c9c9", tamable: true, tameChance: 0.2 },
  { key: "ogre", name: "オーガ", hp: 48, atk: 14, mag: 0, def: 6, spd: 4, exp: 20, jp: 12, color: "#d1704d", tamable: false, tameChance: 0 },
];
